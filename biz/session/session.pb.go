...
type Session struct {
	...
	Guid      string `protobuf:"bytes,4,opt,name=guid,proto3" json:"guid,omitempty"` // version = 1
}
...
func (x *Session) GetAnonymous() bool {
	if x != nil {
		return x.Anonymous
	}
	return false
...
var file_session_proto_rawDesc = []byte{
	...
	0x0c, 0x63, 0x72, 0x67, 0x6f, 0x2e, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x22, 0x6d, 0x0a,
	...
	0x6f, 0x6e, 0x12, 0x1c, 0x0a, 0x09, 0x61, 0x6e, 0x6f, 0x6e, 0x79, 0x6d, 0x6f, 0x75, 0x73, 0x18,
	...
	0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x44, 0x12, 0x12, 0x0a, 0x04, 0x67, 0x75, 0x69, 0x64,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x67, 0x75, 0x69, 0x64, 0x42, 0x0d, 0x5a, 0x0b,
	0x62, 0x69, 0x7a, 0x2f, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_session_proto_goTypes = []interface{}{
	(*Session)(nil), // 0: crgo.gateway.Session
}
